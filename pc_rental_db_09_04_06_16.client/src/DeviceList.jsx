...
/* ---------- モーダル（新規/編集 共通） ---------- */
// この部分がDeviceListコンポーネントよりも前に定義されていることを確認
...
/* ---------- 削除確認 ---------- */
// この部分もDeviceListコンポーネントよりも前に定義されていることを確認
                ...
                <div className="toolbar two-sides">
                    ...
                    <div className="left-group">
                        ...
                        <button
                            ...
                            title="削除モード"
                            onClick={() => setDeleteMode(v => !v)}>－</button>
                    </div>
                    ...
                    <div className="right-group">
                        ...
                        <button
                            ...
                            title="詳細列の表示/非表示"
                            onClick={() => setShowDetails(s => !s)}>…</button>
                    </div>
                </div>

                {/* 途中に出す横スクロールバー（必要な時だけ表示） */}
                {needX && (
                                        ...
                                        <tr key={r.assetNo}>
                                            ...
                                            {showDetails && (
                                                <>
                                                    ...
                                                    <td>{/*fmtDate(r.leaseStart)}</td>
                                                    <td>{fmtDate(r.leaseEnd)}</td>
                                                    <td className="remarks" title={r.remarks || ""}>{r.remarks || ""}</td>
                                                    <td>{fmtDate(r.registerDate)}</td>
                                                    <td>{fmtDate(r.updateDate)*/}</td>
